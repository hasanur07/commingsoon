...
export const GradientShape: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      width="200"
      height="200"
...
export const ArrowOutward: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      ...
      {...props}
    >
      <path d="M6.4 18.4L5 17l9-9H6V6h12v12h-2v-8.4l-9 8.8z" />
    </svg>
  );
};
